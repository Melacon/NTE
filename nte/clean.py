...
import subprocess
import json
from nte.odlregistration import unregisterNeFromOdl, unregisterNeFromOdlNewVersion
import nte.emulator
...
def getDockerNames():
    ...
    stringCmd = "docker ps -a | grep openyumante | awk '{print $NF}'"
    ...
    for line in cmd.stderr:
        ...
        logger.critical("Could not get names of docker containers having image openyumante.\n Stderr: %s", strLine)
